...
urlpatterns = [
    ...
    path('reaction_name_exists/', views.reaction_name_exists, name='reaction_name_exists'),
    path('register_user',views.register_user,name='register_user'),
    path('check-reaction', views.already_saved, name='already_saved'),
    path('available_reactions', views.get_available_reactions, name='available_reactions'),
    path('fetch_rhea_rxn', views.fetch_rhea_rxn, name='fetch_rhea_rxn'),
